...
# =======================================================
t1 <- geojson_read('../Vision-Zero/LionStreet.geojson')
t1[["features"]][[3]][[2]][["Street"]]

steet1 <- lapply(t1$features, function(x) {
...
plot_lanes <- ggplot(data = tjoin2, aes(x = ParkLanes, y = meanInj)) + 
...
# Need to join more streets together
